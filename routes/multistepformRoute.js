...
router.post("/api/post/multistepform/form", async (req, res) => {
  const {
    firstname,
    lastname,
    dob,
...
router.get("/api/get/multistepform/form", async (req, res) => {
  try {
...
router.delete("/api/delete/multistepform/form", async (req, res) => {
  try {
    const { id } = req.body;
